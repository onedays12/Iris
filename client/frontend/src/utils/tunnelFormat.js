...
export function formatBind(tunnel) {
  return `${tunnel.bindHost || '127.0.0.1'}:${tunnel.bindPort || '-'}`
}

export function formatTarget(tunnel) {
...
export function formatTunnelType(type) {
...
export function displayCount(...values) {
