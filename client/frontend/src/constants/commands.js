 ...
 */
export const COMMAND_NAME = Object.fromEntries(
  [
 ...
 * 字符串指令名到 ID 的查找助手
 */
export function getCommandId(name) {
  if (!name) return null;
...
export function normalizeBeaconPlatform(os) {
...
export function normalizeBeaconArch(arch) {
...
export function isCommandSupportedForOS(command, os) {
