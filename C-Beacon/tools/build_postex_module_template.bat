...
set "OUT=postex_module_template.%ARCH%.dll"
set "MOD_OBJ=postex_module_template.%ARCH%.obj"
set "REF_OBJ=reflective_loader.template.%ARCH%.obj"
set "OUTLIB=postex_module_template.%ARCH%.lib"
set "EXP=postex_module_template.%ARCH%.exp"

echo [*] building postex_module_template %ARCH%
pushd "%SCRIPT_DIR%"
cl /nologo /W3 /O2 /MT /GS- /guard:cf- /utf-8 /DWIN32_LEAN_AND_MEAN /DBEACON_DLL_BUILD /I"..\include" /c postex_module_template.c /Fo"%MOD_OBJ%"
if errorlevel 1 (
